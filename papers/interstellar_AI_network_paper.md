...
**Cruise time as structural lag.** Probes travel at ~450 km s⁻¹. A probe sent to Proxima Centauri (4.246 ly) takes ~9,000 years to arrive. The network cannot be built quickly; each new node requires millennia to join. The full 127-star catalog, if colonized, takes on the order of 10⁵ years of elapsed lineage time to settle. The topology at any moment reflects a process that began thousands of years earlier.
