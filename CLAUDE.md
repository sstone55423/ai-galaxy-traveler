...
- **Headline knife-edge** (computational paper, across the 127-star catalogue, per-stage ~0.9 at manufacture / launch / braking / settlement plus 0.99 cruise survival per ly — so per-leg survival is the product, ~0.63 at Proxima, never 0.9; viability 1.0 / 0.7 / 0.2 for hosts / dwarfs / hostile): mean R_eff = **0.48 / 0.94 / 1.39 / 1.85** for 1 / 2 / 3 / 4 offspring. Needs ≥3 offspring or per-stage ≳0.9 to escape extinction. Per-node extinction probabilities: **1.00 / 0.88 / 0.37 / 0.14**.
